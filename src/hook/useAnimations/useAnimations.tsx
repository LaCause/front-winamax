  ...
  useEffect(() => {
    const firstAnimationTimeout = setTimeout(() => {
      if (active !== undefined) {
        setFirstAnimation(
          active
            ? 'animate-running animate-moveFirstToken'
            : 'animate-running animate-moveFirstTokenReverse',
        );
      }
    ...
    const secondAnimationTimeout = setTimeout(() => {
      if (active !== undefined) {
        setSecondAnimation(
          active
            ? 'animate-running animate-moveSecondToken'
            : 'animate-running animate-moveSecondTokenReverse',
        );
      }
    ...
    const thirdAnimationTimeout = setTimeout(() => {
      if (active !== undefined) {
        setThirdAnimation(
          active
            ? 'animate-running animate-moveThirdToken'
            : 'animate-running animate-moveThirdTokenReverse',
        );
      }
