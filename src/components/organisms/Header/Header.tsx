...
export const Header = () => {
    ...
    <header className='z-20 fixed w-full bg-slate-100 flex justify-between border-b-[1.5px] border-[#c2c7d6] mb-2 dark:bg-slate-800 transition px-2'>
        ...
        <div id='test' className='flex self-center rounded-3xl h-auto bg-slate-200 border-1 dark:bg-slate-800 p-[2px] gap-x-1'>
            <input type="checkbox" className="toggle checked:bg-slate-200" onClick={toggleDarkMode} />
            <label className="swap swap-rotate">
                ...
                <svg
                    className="swap-off h-6 w-6 fill-slate-300"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
