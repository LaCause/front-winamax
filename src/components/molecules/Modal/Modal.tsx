        ...
        <div className="modal-box">
          <section className='flex gap-x-7'>
            <label>
              ...
              <input type="range" min={TOURNAMENT_PRICES.MIN} max={TOURNAMENT_PRICES.MAX} className="range range-primary" onChange={(e) => setCurrentMinPrice(parseInt(e.target.value))}/>
            </label>
            <label>
              Prix max : {formatCurrency(currentMaxPrice)}
              <input type="range" min={currentMinPrice} max={TOURNAMENT_PRICES.MAX} className="range range-primary" onChange={(e) => setCurrentMaxPrice(parseInt(e.target.value))}/>
            </label>
          </section>
